...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:////home/christine/Development/code/Phase5/Shop-meetingAPI/Orderservice/orderservice.db'
...
Expected delivery date: {datetime.now().date()} (estimate)
...
Your return request for order #{order.id} has been {return_request.status.lower()}.
