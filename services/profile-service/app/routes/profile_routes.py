...
@bp.route('', methods=['GET'])  # Use empty string with url_prefix
@auth_required
def get_profile():
...
@bp.route('', methods=['PUT', 'PATCH'])  # Use empty string with url_prefix
@auth_required
def update_profile():
...
@bp.route('/preferences', methods=['GET'])  # Now becomes /api/v1/profiles/preferences
@auth_required
def get_preferences():
...
@bp.route('/preferences', methods=['PATCH'])  # Now becomes /api/v1/profiles/preferences
@auth_required
