...
class NotificationSettingsSchema(Schema):
    email_marketing = fields.Boolean(required=False)
    order_updates = fields.Boolean(required=False)
    price_alerts = fields.Boolean(required=False)
    new_products = fields.Boolean(required=False)
    recommendations = fields.Boolean(required=False)
    alert_threshold = fields.Float(required=False)  # 10% price drop
...
class PriceAlertSchema(Schema):
    ...
    notify_on_price_drop = fields.Boolean(required=False)
    notification_threshold = fields.Float(required=False)  # 5% threshold
